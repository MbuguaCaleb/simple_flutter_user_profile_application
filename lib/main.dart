...
class CalebCard extends StatefulWidget {
  @override
  _CalebCardState createState() => _CalebCardState();
}

class _CalebCardState extends State<CalebCard> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            Center(
              child: CircleAvatar(
                backgroundImage: AssetImage('assets/caleb.jpg'),
                radius: 40.0,
              ),
            ),
            Divider(
